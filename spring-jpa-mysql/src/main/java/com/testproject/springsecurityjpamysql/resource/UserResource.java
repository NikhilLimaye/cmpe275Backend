...
public class UserResource {
	...
	public ResponseEntity<String> verifyGoogleUser(@RequestBody Object googleUser) {
		
		Gson g = new Gson();
		Map map = g.fromJson(g.toJson(googleUser), Map.class);	
		String userID = (String) map.get("userID");
		
		UserProfile user = uService.getUserObject(userID);
		if(user == null)
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Login failed. This is not a registered email address");
		else 
